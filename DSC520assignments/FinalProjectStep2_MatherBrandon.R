...
d2019_df_rmrows %>% group_by(OffenseTeam, Down, SeriesFirstDown) %>%
  summarize(n())
#summarizing main variables for data. 
...
#I think the biggest thing I can do is to look at this data not just using the obvious groups that would go together. For example I may find out that against certain teams a team is more likely to pass or run on 4th down or just not go for it at all. 
#This could be helpful for teams during the gameplan part of the week. 
